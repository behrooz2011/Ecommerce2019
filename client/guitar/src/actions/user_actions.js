...
//     const request = axios.get(`${USER_SERVER}/auth`)//api/users/auth
//     .then(response => response.data);
//     // console.log("request:", request);
//     // 'data' is an interinsic part of the componentDidMount
//     return {
//         type: AUTH_USER,
//         payload: request
//     }
...
import {
    ...
    LOGOUT_USER,
    ADD_TO_CART_USER,
    GET_CART_ITEMS_USER,//after the  Cart Compo
    REMOVE_CART_ITEM_USER,
    ON_SUCCESS_BUY_USER,//after paypal
    UPDATE_DATA_USER,//after update user profile
    CLEAR_UPDATE_USER_DATA
} from './types';

import { USER_SERVER , PRODUCT_SERVER } from '../components/utils/misc';
//PRODUCT_SERVER addeded after the Cart Compo Section
